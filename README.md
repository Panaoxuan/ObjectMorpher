...
\<a href="https://www.google.com/search?q=https://panaoxuan.github.io/ObjectMorpher-web/"\>
...
\<a href="https://arxiv.org/abs/2507.05819"\> \<\!-- Update with your actual arxiv link \--\>

\<img src="https://img.shields.io/badge/arXiv-Paper-red?style=for-the-badge\&logo=arxiv\&logoColor=white" alt="ArXiv"/\>

\</a\>

\<a href="https://www.google.com/search?q=https://modelscope.cn/studios/YourName/ObjectMorpher-Composition"\> \<\!-- Update with your actual ModelScope link \--\>

\<img src="https://www.google.com/search?q=https://img.shields.io/badge/ModelScope-Demo-purple%3Fstyle%3Dfor-the-badge" alt="ModelScope"/\>
...
git clone \--recursive \[https://github.com/panaoxuan/ObjectMorpher.git\](https://github.com/panaoxuan/ObjectMorpher.git)  
cd ObjectMorpher
...
python \-m preprocess.sam\_processor \-i inputs/image.jpg \-o outputs/

\# Reconstruct 3DGS via TRELLIS  
python \-m reconstruct\_from\_2d.app
...
python \-m editing.edit\_gui \--gs\_path reconstruct\_from\_2d/gs\_ply/gaussian\_model.ply
...
python \-m inpainting.infer\_pixelhacker \\  
\--config inpainting/config/PixelHacker\_sdvae\_f8d4.yaml \\  
\--weight weight/ft\_places/diffusion\_pytorch\_model.bin
...
1. Visit our hosted LoRA on ModelScope: [**ObjectMorpher Generative Composition Demo**](https://www.google.com/search?q=%23) *(Replace with your link)*.  
...
\<img src="materials/images/car1\_back.png" alt="Car Back View Edit" width="30%"/\>

\<img src="materials/images/car1\_opposite.png" alt="Car Opposite View Edit" width="30%"/\>
...
\<img src="materials/images/mecha2\_kick.png" alt="Mecha Kick Action" width="30%"/\>

\<img src="materials/images/mecha2\_run.png" alt="Mecha Run Action" width="30%"/\>
...
@inproceedings{xie2026objectmorpher,  
...
* [**Segment Anything (SAM)**](https://github.com/facebookresearch/segment-anything) & [**PixelHacker**](https://www.google.com/search?q=https://github.com/PixelHacker): For powering our object extraction and background inpainting pipelines.  
* [**DiffSynth-Studio**](https://www.google.com/search?q=https://github.com/modelscope/DiffSynth-Studio) & **Qwen-Image-Edit**: For the powerful foundation model framework that drives our generative composition module.